...
class Opponent extends Character {
    ...
    die() {
        ...
        if (!this.dead) {
            //Suma un punto a score cada vez que un oponente muere
            this.game.score+=1;
            document.getElementById("scoreli").innerHTML = this.game.score;
            //Comprobamos cuantos oponentes han muerto
